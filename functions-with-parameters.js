...
console.log(`\n37 minutes are ${minutesToSeconds(37)} seconds\n`);
...
const wrapper = (string1, char) => {
  return `${char}${string1}${char}`;
}
console.log(wrapper("anything", "="));
